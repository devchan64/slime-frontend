...
async function inspectDelayedBagResponse(changeCurrentSession, rejectedRequestValue) {
  ...
  try {
    BagPanel({me:currentCharacterState,gameSessionClient:currentSessionClient});
