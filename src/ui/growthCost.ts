...
export function growthCost(category: "attributes" | "skills", attributes: Record<string, number>, skills: Record<string, number>, baselines: Record<string, number> = {}) {
  ...
  for (const [key, level] of Object.entries(skills)) {
    ...
    if (category === "skills") count += level - baseline;
  }
